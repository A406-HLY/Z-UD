...
@DisplayName("LocalTaxCertificateContentValidator 단위 테스트")
class LocalTaxCertificateContentValidatorTest {

	private final LocalTaxCertificateContentValidator validator =
	...
	@Test
	@DisplayName("getSupportedTag는_File_012_반환")
	void getSupportedTag는_File_012_반환() {
		assertThat(validator.getSupportedTag())
			.isEqualTo(DocumentTag.FILE_012_LOCAL_TAX_CERTIFICATE);
	}
	...
	class Validate {
		...
		void 발급일이_30일_이내면_빈_리스트_반환() {
			...
			LocalTaxCertificateContent content = LocalTaxCertificateContent.builder()
