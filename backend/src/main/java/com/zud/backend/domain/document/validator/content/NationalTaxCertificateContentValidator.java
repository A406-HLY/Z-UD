...
@Component
public class NationalTaxCertificateContentValidator
	implements DocumentContentValidator<NationalTaxCertificateContent> {
	...
	@Override
	public List<String> validate(final NationalTaxCertificateContent content) {
